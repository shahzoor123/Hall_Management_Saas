...
$("#overlapping-bars").length &&
  ...
  $("#animating-donut").length &&
    ((chart = new Chartist.Pie(
      "#animating-donut",
      
      { series: [70, 30, 40, 40, 20, 30, 10], labels: [1, 2, 3, 4, 5, 6, 7] },
